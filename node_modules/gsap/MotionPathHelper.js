 ...
 */
    ...
    let t, e = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, s = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi,
        i = Math.PI / 180, n = Math.sin, o = Math.cos, r = Math.abs, a = Math.sqrt,
    ...
    function g(t, e, s, h, l, c, d, g, p) {
        ...
        let u = l % 360 * i, _ = o(u), f = n(u), m = Math.PI, b = 2 * m, v = (t - g) / 2, y = (e - p) / 2,
            A = _ * v + f * y, w = -f * v + _ * y, x = A * A, P = w * w, S = x / (s * s) + P / (h * h);
        S > 1 && (s = a(S) * s, h = a(S) * h);
        let C = s * s, E = h * h, k = (C * E - C * P - E * x) / (C * P + E * x);
        k < 0 && (k = 0);
        let M = (c === d ? -1 : 1) * a(k), D = M * (s * w / h), T = M * (-h * A / s), H = (t + g) / 2 + (_ * D - f * T),
            R = (e + p) / 2 + (f * D + _ * T), N = (A - D) / s, L = (w - T) / h, X = (-A - D) / s, I = (-w - T) / h,
            O = N * N + L * L, q = (L < 0 ? -1 : 1) * Math.acos(N / a(O)),
            Y = (N * I - L * X < 0 ? -1 : 1) * Math.acos((N * X + L * I) / a(O * (X * X + I * I)));
        isNaN(Y) && (Y = m), !d && Y > 0 ? Y -= b : d && Y < 0 && (Y += b), q %= b, Y %= b;
        let V, G = Math.ceil(r(Y) / (b / 4)), j = [], z = Y / G, B = 4 / 3 * n(z / 2) / (1 + o(z / 2)), W = _ * s,
            F = f * s, U = f * -h, Z = _ * h;
        for (V = 0; V < G; V++) A = o(l = q + V * z), w = n(l), N = o(l += z), L = n(l), j.push(A - B * w, w + B * A, N + B * L, L - B * N, N, L);
        for (V = 0; V < j.length; V += 2) A = j[V], w = j[V + 1], j[V] = A * W + w * U + H, j[V + 1] = A * F + w * Z + R;
        return j[V - 2] = g, j[V - 1] = p, j
    }
    ...
    function p(t) {
        let i, n, o, a, h, l, c, d, p, u, _, f, m, b, v, y = (t + "").replace(s, t => {
            ...
            }).match(e) || [], A = [], w = 0, x = 0, P = y.length, S = 0, C = "ERROR: malformed path: " + t,
            E = function (t, e, s, i) {
                u = (s - t) / 3, _ = (i - e) / 3, c.push(t + u, e + _, s - u, i - _, s, i)
            };
        if (!t || !isNaN(y[0]) || isNaN(y[1])) return console.log(C), A;
        for (i = 0; i < P; i++) if (m = h, isNaN(y[i]) ? (h = y[i].toUpperCase(), l = h !== y[i]) : i--, o = +y[i + 1], a = +y[i + 2], l && (o += w, a += x), i || (d = o, p = a), "M" === h) c && (c.length < 8 ? A.length -= 1 : S += c.length), w = d = o, x = p = a, c = [o, a], A.push(c), i += 2, h = "L"; else if ("C" === h) c || (c = [0, 0]), l || (w = x = 0), c.push(o, a, w + 1 * y[i + 3], x + 1 * y[i + 4], w += 1 * y[i + 5], x += 1 * y[i + 6]), i += 6; else if ("S" === h) u = w, _ = x, "C" !== m && "S" !== m || (u += w - c[c.length - 4], _ += x - c[c.length - 3]), l || (w = x = 0), c.push(u, _, o, a, w += 1 * y[i + 3], x += 1 * y[i + 4]), i += 4; else if ("Q" === h) u = w + 2 / 3 * (o - w), _ = x + 2 / 3 * (a - x), l || (w = x = 0), w += 1 * y[i + 3], x += 1 * y[i + 4], c.push(u, _, w + 2 / 3 * (o - w), x + 2 / 3 * (a - x), w, x), i += 4; else if ("T" === h) u = w - c[c.length - 4], _ = x - c[c.length - 3], c.push(w + u, x + _, o + 2 / 3 * (w + 1.5 * u - o), a + 2 / 3 * (x + 1.5 * _ - a), w = o, x = a), i += 2; else if ("H" === h) E(w, x, w = o, x), i += 1; else if ("V" === h) E(w, x, w, x = o + (l ? x - w : 0)), i += 1; else if ("L" === h || "Z" === h) "Z" === h && (o = d, a = p, c.closed = !0), ("L" === h || r(w - o) > .5 || r(x - a) > .5) && (E(w, x, o, a), "L" === h && (i += 2)), w = o, x = a; else if ("A" === h) {
            if (b = y[i + 4], v = y[i + 5], u = y[i + 6], _ = y[i + 7], n = 7, b.length > 1 && (b.length < 3 ? (_ = u, u = v, n--) : (_ = v, u = b.substr(2), n -= 2), v = b.charAt(1), b = b.charAt(0)), f = g(w, x, +y[i + 1], +y[i + 2], +y[i + 3], +b, +v, (l ? w : 0) + 1 * u, (l ? x : 0) + 1 * _), i += n, f) for (n = 0; n < f.length; n++) c.push(f[n]);
            w = c[c.length - 2], x = c[c.length - 1]
        } else console.log(C);
        return i = c.length, i < 6 ? (A.pop(), i = 0) : c[0] === c[i - 2] && c[1] === c[i - 1] && (c.closed = !0), A.totalPoints = S + i, A
    }

    function u(t, e, s, i, n, o, a, h, l, c, d) {
        let g, p = (t + s) / 2, _ = (e + i) / 2, f = (s + n) / 2, m = (i + o) / 2, b = (n + a) / 2, v = (o + h) / 2,
            y = (p + f) / 2, A = (_ + m) / 2, w = (f + b) / 2, x = (m + v) / 2, P = (y + w) / 2, S = (A + x) / 2,
            C = a - t, E = h - e, k = r((s - a) * E - (i - h) * C), M = r((n - a) * E - (o - h) * C);
        return c || (c = [t, e, a, h], d = 2), c.splice(d || c.length - 2, 0, P, S), (k + M) * (k + M) > l * (C * C + E * E) && (g = c.length, u(t, e, p, _, y, A, P, S, l, c, d), u(P, S, w, x, b, v, a, h, l, c, d + 2 + (c.length - g))), c
    }

    function _(t, e) {
        r(t[0] - t[2]) < 1e-4 && r(t[1] - t[3]) < 1e-4 && (t = t.slice(2));
        let s, i, n, o, l, c, d, g, p, u, _, f, m, b, v, y = t.length - 2, A = +t[0], w = +t[1], x = +t[2], P = +t[3],
            S = [A, w, A, w], C = x - A, E = P - w, k = Math.abs(t[y] - A) < .001 && Math.abs(t[y + 1] - w) < .001;
        for (k && (t.push(x, P), x = A, P = w, A = t[y - 2], w = t[y - 1], t.unshift(A, w), y += 4), e = e || 0 === e ? +e : 1, n = 2; n < y; n += 2) s = A, i = w, A = x, w = P, x = +t[n + 2], P = +t[n + 3], A === x && w === P || (o = C, l = E, C = x - A, E = P - w, c = a(o * o + l * l), d = a(C * C + E * E), g = a((C / d + o / c) ** 2 + (E / d + l / c) ** 2), p = (c + d) * e * .25 / g, u = A - (A - s) * (c ? p / c : 0), _ = A + (x - A) * (d ? p / d : 0), f = A - (u + ((_ - u) * (3 * c / (c + d) + .5) / 4 || 0)), m = w - (w - i) * (c ? p / c : 0), b = w + (P - w) * (d ? p / d : 0), v = w - (m + ((b - m) * (3 * c / (c + d) + .5) / 4 || 0)), A === s && w === i || S.push(h(u + f), h(m + v), h(A), h(w), h(_ + f), h(b + v)));
        return A !== x || w !== P || S.length < 4 ? S.push(h(x), h(P), h(x), h(P)) : S.length -= 2, 2 === S.length ? S.push(A, w, A, w, A, w) : k && (S.splice(0, 6), S.length = S.length - 6), S
    }
    ...
    function b(e, s, i, n, o, r, a, h, l, c, d, g, p, u) {
        let _, f, m, v, y, A, w = (o - n) / r, x = 0, P = n;
        for (t = 1e8; P <= o;) A = 1 - P, _ = A * A * A * a + 3 * A * A * P * l + 3 * A * P * P * d + P * P * P * p, f = A * A * A * h + 3 * A * A * P * c + 3 * A * P * P * g + P * P * P * u, v = _ - s, y = f - i, m = v * v + y * y, m < t && (t = m, x = P), P += w;
        return e > 1 ? b(e - 1, s, i, Math.max(x - w, 0), Math.min(x + w, 1), r, a, h, l, c, d, g, p, u) : x
    }

    let v, y, A, w, x, P, S, C, E, k = "transform", M = k + "Origin", D = t => {
            let e = t.ownerDocument || t;
            !(k in t.style) && "msTransform" in t.style && (k = "msTransform", M = k + "Origin");
            for (; e.parentNode && (e = e.parentNode);) ;
            if (y = window, S = new O, e) {
                v = e, A = e.documentElement, w = e.body, C = v.createElementNS("http://www.w3.org/2000/svg", "g"), C.style.transform = "none";
                let t = e.createElement("div"), s = e.createElement("div");
                w.appendChild(t), t.appendChild(s), t.style.position = "static", t.style[k] = "translate3d(0,0,1px)", E = s.offsetParent !== t, w.removeChild(t)
            }
            return e
        }, T = [], H = [], R = t => t.ownerSVGElement || ("svg" === (t.tagName + "").toLowerCase() ? t : null),
        N = t => "fixed" === y.getComputedStyle(t).position || ((t = t.parentNode) && 1 === t.nodeType ? N(t) : void 0),
        L = (t, e) => {
            if (t.parentNode && (v || D(t))) {
                ...
                return e && (s ? (P || (P = L(t)), h.setAttribute("width", .01), h.setAttribute("height", .01), h.setAttribute("transform", "translate(" + o + "," + r + ")"), P.appendChild(h)) : (x || (x = L(t), x.style.cssText = a), h.style.cssText = a + "width:0.1px;height:0.1px;top:" + r + "px;left:" + o + "px", x.appendChild(h))), h
            }
            throw"Need document and parent."
        }, X = (t, e) => {
            let s, i, n, o, r, a, h = R(t), l = t === h, c = h ? T : H, d = t.parentNode;
            if (t === y) return t;
            if (c.length || c.push(L(t, 1), L(t, 2), L(t, 3)), s = h ? P : x, h) l ? (n = (t => {
                let e, s = t.getCTM();
                return s || (e = t.style[k], t.style[k] = "none", t.appendChild(C), s = C.getCTM(), t.removeChild(C), e ? t.style[k] = e : t.style.removeProperty(k.replace(/([A-Z])/g, "-$1").toLowerCase())), s || S.clone()
            })(t), o = -n.e / n.a, r = -n.f / n.d, i = S) : t.getBBox ? (n = t.getBBox(), i = t.transform ? t.transform.baseVal : {}, i = i.numberOfItems ? i.numberOfItems > 1 ? (t => {
                let e = new O, s = 0;
                for (; s < t.numberOfItems; s++) e.multiply(t.getItem(s).matrix);
                return e
            })(i) : i.getItem(0).matrix : S, o = i.a * n.x + i.c * n.y, r = i.b * n.x + i.d * n.y) : (i = new O, o = r = 0), e && "g" === t.tagName.toLowerCase() && (o = r = 0), (l ? h : d).appendChild(s), s.setAttribute("transform", "matrix(" + i.a + "," + i.b + "," + i.c + "," + i.d + "," + (i.e + o) + "," + (i.f + r) + ")"); else {
            ...
            return s
        }, I = (t, e, s, i, n, o, r) => (t.a = e, t.b = s, t.c = i, t.d = n, t.e = o, t.f = r, t);
    ...
    class O {
        ...
        inverse() {
            ...
            return I(this, i / r, -e / r, -s / r, t / r, (s * o - i * n) / r, -(t * o - e * n) / r)
        }

        multiply(t) {
            let {a: e, b: s, c: i, d: n, e: o, f: r} = this, a = t.a, h = t.c, l = t.b, c = t.d, d = t.e, g = t.f;
            return I(this, a * e + l * i, a * s + l * n, h * e + c * i, h * s + c * n, o + d * e + g * i, r + d * s + g * n)
        }
    ...
    function q(t, e, s, i) {
        if (!t || !t.parentNode || (v || D(t)).documentElement === t) return new O;
        let n = (t => {
                let e, s;
                ...
                return e
            })(t), o = R(t) ? T : H, r = X(t, s), a = o[0].getBoundingClientRect(), h = o[1].getBoundingClientRect(),
            l = o[2].getBoundingClientRect(), c = r.parentNode, d = !i && N(t),
            g = new O((h.left - a.left) / 100, (h.top - a.top) / 100, (l.left - a.left) / 100, (l.top - a.top) / 100, a.left + (d ? 0 : y.pageXOffset || v.scrollLeft || A.scrollLeft || w.scrollLeft || 0), a.top + (d ? 0 : y.pageYOffset || v.scrollTop || A.scrollTop || w.scrollTop || 0));
        if (c.removeChild(r), n) for (a = n.length; a--;) h = n[a], h.scaleX = h.scaleY = 0, h.renderTransform(1, h);
        return e ? g.inverse() : g
    }

    let Y, V, G, j, z, B, W, F, U, Z, $, K, Q, J = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, tt = Math.PI / 180,
        et = Date.now || (() => (new Date).getTime()), st = 0, it = 0, nt = () => !1, ot = {}, rt = [], at = {},
        ht = [], lt = [], ct = t => {
            t.preventDefault && (t.preventDefault(), t.preventManipulation && t.preventManipulation())
        }, dt = t => Y.createElementNS ? Y.createElementNS("http://www.w3.org/1999/xhtml", t) : Y.createElement(t),
        gt = (t, e, s) => {
        ...
        }, pt = {matrix: new O}, ut = t => (t.transform && t.transform.baseVal.consolidate() || pt).matrix,
        _t = t => ~~(1e3 * t + (t < 0 ? -.5 : .5)) / 1e3, ft = function (t) {
            if (!t.target._gsSelection && !it && et() - st > 100) {
                let t = lt.length;
                for (; --t > -1;) lt[t].deselect();
                lt.length = 0
            }
        }, mt = 0, bt = (t, e, s, i) => {
            ...
            mt = t.touches && _dragCount < t.touches.length, vt(t.target, "touchend", yt)
        }, At = t => {
            mt = t.touches && _dragCount < t.touches.length, bt(t.target, "touchend", yt)
        }, wt = (t, e) => s => t.call(e, s), xt = (t, e, s) => {
            let i = e.vars[t];
            return i && i.call(e.vars.callbackScope || e, s || e), e
        }, Pt = () => {
            K.style.display = "block", K.select(), K.style.display = "none"
        }, St = () => {
            Y = document, G = window, j = Y.body, Z = dt("div"), K = dt("textarea"), K.style.display = "none", j && j.appendChild(K), $ = function (t) {
                let e = t.split(","),
                    s = (void 0 !== Z.onpointerdown ? "pointerdown,pointermove,pointerup,pointercancel" : void 0 !== Z.onmspointerdown ? "MSPointerDown,MSPointerMove,MSPointerUp,MSPointerCancel" : t).split(","),
                    i = {}, n = 4;
                ...
                if ("Shift" === r || 16 === o) W = !0; else if ("Control" === r || 17 === o) z = !0; else if ("Meta" === r || 91 === o) F = !0; else if ("Alt" === r || 18 === o) for (B = !0, e = lt.length; --e > -1;) lt[e]._onPressAlt(); else if (("z" === r || 90 === o) && (z || F) && rt.length > 1) {
                    if (rt.shift(), s = rt[0], s) {
            ...
            if (i._enabled && !mt && i.isPressed && t) {
                ...
                ct(n), i.setPointerPosition(t.pageX, t.pageY), i.vars.onDrag && i.vars.onDrag.call(i.vars.callbackScope || i, i.pointerEvent)
            }
        }, kt = function (t, e) {
            let s = this;
            ...
            st = et(), s.isPressed = it = !1;
            let i, n, o = t, r = s.isDragging, a = s.touchEventTarget;
            if (a ? (vt(a, "touchend", s._onRelease), vt(a, "touchmove", s._onMove), vt(a, "touchcancel", s._onRelease), vt(Y, "touchstart", At)) : vt(Y, "mousemove", s._onMove), V || (vt(Y, "mouseup", s._onRelease), t && t.target && vt(t.target, "mouseup", s._onRelease)), r ? s.isDragging = !1 : s.vars.onClick && s.vars.onClick.call(s.vars.callbackScope || s, o), t) {
            ...
            return o && !r && s.vars.onDragRelease ? s.vars.onDragRelease.call(s, s.pointerEvent) : (o && ct(o), s.vars.onRelease && s.vars.onRelease.call(s.vars.callbackScope || s, s.pointerEvent)), r && s.vars.onDragEnd && s.vars.onDragEnd.call(s.vars.callbackScope || s, s.pointerEvent), !0
        }, Mt = (t, e, s, i) => {
            let n, o = t[e], r = o.length - (o.closed ? 6 : 0), a = [];
            for (n = 0; n < r; n += 6) a.push(new Ht(s, t, e, n, i));
    ...
    class Tt {
        ...
        setPointerPosition(t, e) {
            let s, i, n, o, r;
            this.pointerX = t, this.pointerY = e, this._ctm && (r = t * this._ctm.a + e * this._ctm.c + this._ctm.e, e = t * this._ctm.b + e * this._ctm.d + this._ctm.f, t = r), i = e - this._startPointerY, s = t - this._startPointerX, i < 1 && i > -1 && (i = 0), s < 1 && s > -1 && (s = 0), n = (1e3 * (this._startElementX + s) | 0) / 1e3, o = (1e3 * (this._startElementY + i) | 0) / 1e3, this.snap && !W && (at.x = n, at.y = o, this.snap.call(this, at), n = at.x, o = at.y), this.x === n && this.y === o || (this._matrix.f = this.y = o, this._matrix.e = this.x = n, !this.isDragging && this.isPressed && (this.isDragging = !0, xt("onDragStart", this, this.pointerEvent)))
        }

        enabled(t) {
            if (!arguments.length) return this._enabled;
            let e;
            return this._enabled = t, t ? (V || bt(this.target, "mousedown", this._onPress), bt(this.target, "touchstart", this._onPress), bt(this.target, "click", this._onClick, !0)) : (e = this.isDragging, vt(this.target, "mousedown", this._onPress), vt(this.target, "touchstart", this._onPress), vt(G, "touchforcechange", ct), vt(this.target, "click", this._onClick), this.touchEventTarget && (vt(this.touchEventTarget, "touchcancel", this._onRelease), vt(this.touchEventTarget, "touchend", this._onRelease), vt(this.touchEventTarget, "touchmove", this._onMove)), vt(Y, "mouseup", this._onRelease), vt(Y, "mousemove", this._onMove), this.isDragging = this.isPressed = !1, e && xt("onDragEnd", this, this.pointerEvent)), this
        }
    ...
    class Ht {
        constructor(t, e, s, i, n) {
            this.editor = t, this.element = gt("path", t._selection, {
                fill: "#4e7fff",
                stroke: "#4e7fff",
                strokeWidth: 2,
                vectorEffect: "non-scaling-stroke"
            }), this.update(e, s, i), this.element._gsSelection = !0, this.vars = n || {}, this._draggable = new Tt(this.element, {
                callbackScope: this,
                onDrag: this.onDrag,
                snap: this.vars.snap,
    ...
    class Rt {
        constructor(t, e) {
            e = e || {}, Q || St(), this.vars = e, this.path = "string" == typeof t ? Y.querySelectorAll(t)[0] : t, this._g = gt("g", this.path.ownerSVGElement, {class: "path-editor-g path-editor"}), this._selectionHittest = gt("path", this._g, {
                stroke: "transparent",
                strokeWidth: 16,
                fill: "none",
                vectorEffect: "non-scaling-stroke"
            }), this._selection = e._selection || gt("g", this._g, {class: "path-editor-selection path-editor"}), this._selectionPath = gt("path", this._selection, {
                stroke: "#4e7fff",
                strokeWidth: 2,
                fill: "none",
                vectorEffect: "non-scaling-stroke"
            }), this._selectedAnchors = [], this._line1 = gt("polyline", this._selection, {
                stroke: "#4e7fff",
                strokeWidth: 2,
                vectorEffect: "non-scaling-stroke"
            }), this._line2 = gt("polyline", this._selection, {
                stroke: "#4e7fff",
                strokeWidth: 2,
                vectorEffect: "non-scaling-stroke"
            ...
            this._squareHandle = (t => ["M-" + (t = _t(t)), -t, t, -t, t, t, -t, t + "z"].join(","))(i), this._circleHandle = (t => {
                let e = _t(.552284749831 * t);
                return "M" + (t = _t(t)) + ",0C" + [t, e, e, t, 0, t, -e, t, -t, e, -t, 0, -t, -e, -e, -t, 0, -t, e, -t, t, -e, t, 0].join(",") + "z"
            })(1.15 * i), this._handle1 = gt("path", this._selection, {
                d: this._squareHandle,
                fill: "#4e7fff",
                stroke: "transparent",
                strokeWidth: 6
            }), this._handle2 = gt("path", this._selection, {
                d: this._squareHandle,
                fill: "#4e7fff",
                stroke: "transparent",
                strokeWidth: 6
            }), this._handle1._draggable = new Tt(this._handle1, {
                ...
                snap: e.handleSnap
            }), this._handle2._draggable = new Tt(this._handle2, {
            ...
            !1 !== e.draggable && (this._draggable = new Tt(this._selectionHittest, {
                callbackScope: this,
                onPress: this.select,
                ...
                maxX: this.vars.maxX,
                minX: this.vars.minX
            })), this.init(), this._selection.style.visibility = !1 === e.selected ? "hidden" : "visible", !1 !== e.selected && (this.path._gsSelection = !0, lt.push(this)), this._saveState(), V || (bt(this._selectionHittest, "mousedown", wt(this._onClickSelectionPath, this)), bt(this._selectionHittest, "mouseup", wt(this._onRelease, this))), bt(this._selectionHittest, "touchstart", wt(this._onClickSelectionPath, this)), bt(this._selectionHittest, "touchend", wt(this._onRelease, this))
        }

        _onRelease(t) {
            let e = this._editingAnchor;
            e && (ot.x = e.segment[e.i], ot.y = e.segment[e.i + 1]), vt(G, "touchforcechange", ct), xt("onRelease", this, t)
        }
        ...
        init() {
            ...
            if (this._rawPath = i, o) {
                if (this._anchors = Mt(i, 0, this, r), t = i.length, t > 1) for (e = 1; e < t; e++) this._anchors = this._anchors.concat(Mt(i, e, this, r))
            ...
            return this._selection.appendChild(this._handle1), this._selection.appendChild(this._handle2), this._selectionPath.setAttribute("d", s), this._selectionHittest.setAttribute("d", s), this._g.setAttribute("transform", (t => {
                let e = ut(t), s = t.ownerSVGElement;
                for (; (t = t.parentNode) && t.ownerSVGElement === s;) e.multiply(ut(t));
        ...
        _saveState() {
            (t => {
                ...
                rt.unshift({
                    ...
                    selectedIndexes: s
                }), rt.length > 30 && (rt.length = 30)
            })(this)
        }

        _onClickSelectionPath(e) {
            if ("hidden" === this._selection.style.visibility) this.select(); else if (B || e && e.altKey) {
                let s, i, n, o, r, a, l = {
                    callbackScope: this,
                    snap: this.vars.anchorSnap,
                    onDrag: this._onDragAnchor,
                ...
                for (this._draggable && this._draggable._onRelease(e), c && (o = e.clientX * c.a + e.clientY * c.c + c.e, r = e.clientX * c.b + e.clientY * c.d + c.f), a = function (e, s, i, n) {
                    ...
                    if (s <= 0 || s >= 1) return 0;
                    let i = t[e], n = t[e + 1], o = t[e + 2], r = t[e + 3], a = t[e + 4], l = t[e + 5],
                        c = i + (o - i) * s, d = o + (a - o) * s, g = n + (r - n) * s, p = r + (l - r) * s,
                        u = c + (d - c) * s, _ = g + (p - g) * s, f = a + (t[e + 6] - a) * s,
                        m = l + (t[e + 7] - l) * s;
                ...
                n = new Ht(this, this._rawPath, a.j, s, l), this._selection.appendChild(this._handle1), this._selection.appendChild(this._handle2), n._draggable._onPress(e), U = n, this._anchors.push(n), this._selectedAnchors.length = 0, this._selectedAnchors.push(n), this._updateAnchors(), this.update(), this._saveState()
            }
            Pt(), bt(G, "touchforcechange", ct), xt("onPress", this)
        }

        _onClickHandle1() {
            let t = this._editingAnchor, e = t.i, s = t.segment, i = t.isClosedStart ? s.length - 4 : e - 2;
            B && Math.abs(s[e] - s[i]) < 5 && Math.abs(s[e + 1] - s[i + 1]) < 5 && this._onClickAnchor(t)
        }

        _onClickHandle2() {
            let t = this._editingAnchor, e = t.i, s = t.segment;
            B && Math.abs(s[e] - s[e + 2]) < 5 && Math.abs(s[e + 1] - s[e + 3]) < 5 && this._onClickAnchor(t)
        }

        _onDragEndAnchor(t) {
            U = null, this._saveState()
        }
        ...
        select(t) {
            ...
            return -1 === lt.indexOf(this) && lt.push(this), this._updateAnchors(), this
        }

        deselect() {
            return this._selection.style.visibility = "hidden", this._selectedAnchors.length = 0, this._editingAnchor = null, this.path._gsSelection = !1, lt.splice(lt.indexOf(this), 1), this._updateAnchors(), this
        }
        ...
        _onPressAnchor(t) {
            -1 === this._selectedAnchors.indexOf(t) ? (W || (this._selectedAnchors.length = 0), this._selectedAnchors.push(t)) : W && (this._selectedAnchors.splice(this._selectedAnchors.indexOf(t), 1), t._draggable.endDrag()), ot.x = t.segment[t.i], ot.y = t.segment[t.i + 1], this._updateAnchors(), xt("onPress", this)
        }
        ...
        _onPressHandle1() {
            this._editingAnchor.smooth && (this._oppositeHandleLength = Dt(this._editingAnchor.segment, this._editingAnchor.i, this._editingAnchor.i + 2)), xt("onPress", this)
        }

        _onPressHandle2() {
            this._editingAnchor.smooth && (this._oppositeHandleLength = Dt(this._editingAnchor.segment, this._editingAnchor.isClosedStart ? this._editingAnchor.segment.length - 4 : this._editingAnchor.i - 2, this._editingAnchor.i)), xt("onPress", this)
        }
        ...
        _onDragHandle1() {
            ...
            s[n] = o = (1e3 * o | 0) / 1e3, s[n + 1] = r = (1e3 * r | 0) / 1e3, e.smooth && (B ? (e.smooth = !1, e.element.setAttribute("d", this._squareHandle), this._handle1.setAttribute("d", this._squareHandle), this._handle2.setAttribute("d", this._squareHandle)) : (t = Math.atan2(s[i + 1] - r, s[i] - o), o = this._oppositeHandleLength * Math.cos(t), r = this._oppositeHandleLength * Math.sin(t), s[i + 2] = (1e3 * (s[i] + o) | 0) / 1e3, s[i + 3] = (1e3 * (s[i + 1] + r) | 0) / 1e3)), this.update()
        }

        _onDragHandle2() {
            let t, e = this._editingAnchor, s = e.segment, i = e.i, n = e.isClosedStart ? s.length - 4 : i - 2,
                o = this._handle2._draggable.x, r = this._handle2._draggable.y;
            s[i + 2] = o = (1e3 * o | 0) / 1e3, s[i + 3] = r = (1e3 * r | 0) / 1e3, e.smooth && (B ? (e.smooth = !1, e.element.setAttribute("d", this._squareHandle), this._handle1.setAttribute("d", this._squareHandle), this._handle2.setAttribute("d", this._squareHandle)) : (t = Math.atan2(s[i + 1] - r, s[i] - o), o = this._oppositeHandleLength * Math.cos(t), r = this._oppositeHandleLength * Math.sin(t), s[n] = (1e3 * (s[i] + o) | 0) / 1e3, s[n + 1] = (1e3 * (s[i + 1] + r) | 0) / 1e3)), this.update()
        }
        ...
        update(t) {
            ...
            return this.vars.onUpdate && this._enabled && xt("onUpdate", this, r), this
        }
        ...
        getNormalizedSVG(t, e, s, i) {
            ...
            for (ht.length = 0, f = f ? 1 / f : -_, _ *= 1e3, f *= 1e3, o = 0; o < p; o += 2) ht[o] = ((c[o] + d) * _ | 0) / 1e3, ht[o + 1] = ((c[o + 1] + g) * f | 0) / 1e3;
            if (i) {
                for (n = [], p = ht.length, o = 2; o < p; o += 6) r = ht[o - 2], a = ht[o - 1], h = ht[o + 4], l = ht[o + 5], n.push(r, a, h, l), u(r, a, ht[o], ht[o + 1], ht[o + 2], ht[o + 3], h, l, .001, n, n.length - 2);
            ...
            return s && 8 === p && 0 === ht[0] && 0 === ht[1] && 1 === ht[p - 2] && 1 === ht[p - 1] ? ht.slice(2, 6).join(",") : (ht[2] = "C" + ht[2], "M" + ht.join(","))
        }
    }

    Rt.simplifyPoints = m, Rt.pointsToSegment = _, Rt.simplifySVG = (t, e) => {
        let s, i, n, o, r, a, h, l, c, d, g, f;
        if (d = (e = e || {}).tolerance || 1, c = e.precision || 1 / d, f = (void 0 === e.cornerThreshold ? 18 : +e.cornerThreshold) * tt, "string" != typeof t && (s = t, t = s.getAttribute("d")), "#" !== t.charAt(0) && "." !== t.charAt(0) || (s = Y.querySelector(t), s && (t = s.getAttribute("d"))), i = !1 !== e.curved || /[achqstvz]/gi.test(t) ? p(t)[0] : t.match(J), !1 !== e.curved) {
            for (l = i, i = [], g = l.length, n = 2; n < g; n += 6) o = +l[n - 2], a = +l[n - 1], r = +l[n + 4], h = +l[n + 5], i.push(_t(o), _t(a), _t(r), _t(h)), u(o, a, +l[n], +l[n + 1], +l[n + 2], +l[n + 3], r, h, 1 / (2e5 * c), i, i.length - 2);
            i = _(m(i, d), e.curviness), i[2] = "C" + i[2]
        } else i = m(i, d);
        return t = "M" + i.join(","), s && s.setAttribute("d", t), t
    }, Rt.create = (t, e) => new Rt(t, e), Rt.editingAxis = ot, Rt.getSnapFunction = t => {
    ...
    let Nt, Lt, Xt, It, Ot, qt, Yt, Vt, Gt, jt = function () {
            return String.fromCharCode.apply(null, arguments)
        }, zt = jt(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), Bt = (function (t) {
            var e = "undefined" != typeof window,
                ...
                n = function () {
                    e && ("loading" === document.readyState || "interactive" === document.readyState ? document.addEventListener("readystatechange", n) : (document.removeEventListener("readystatechange", n), e && window.console && !window._gsapWarned && "object" == typeof window.gsap && !1 !== window.gsap.config().trialWarn && (console.log(jt(37, 99, 87, 97, 114, 110, 105, 110, 103), jt(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)), console.log(jt(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) + "MotionPathHelper" + jt(32, 105, 115, 32, 108, 111, 97, 100, 101, 100, 32, 116, 104, 97, 116, 32, 111, 110, 108, 121, 32, 119, 111, 114, 107, 115, 32, 108, 111, 99, 97, 108, 108, 121, 32, 97, 110, 100, 32, 111, 110, 32, 100, 111, 109, 97, 105, 110, 115, 32, 108, 105, 107, 101, 32, 99, 111, 100, 101, 112, 101, 110, 46, 105, 111, 32, 97, 110, 100, 32, 99, 111, 100, 101, 115, 97, 110, 100, 98, 111, 120, 46, 105, 111, 46, 32, 42, 42, 42, 32, 68, 79, 32, 78, 79, 84, 32, 68, 69, 80, 76, 79, 89, 32, 84, 72, 73, 83, 32, 70, 73, 76, 69, 32, 42, 42, 42, 32, 76, 111, 97, 100, 105, 110, 103, 32, 105, 116, 32, 111, 110, 32, 97, 110, 32, 117, 110, 97, 117, 116, 104, 111, 114, 105, 122, 101, 100, 32, 115, 105, 116, 101, 32, 118, 105, 111, 108, 97, 116, 101, 115, 32, 116, 104, 101, 32, 108, 105, 99, 101, 110, 115, 101, 32, 97, 110, 100, 32, 119, 105, 108, 108, 32, 99, 97, 117, 115, 101, 32, 97, 32, 114, 101, 100, 105, 114, 101, 99, 116, 46, 32, 80, 108, 101, 97, 115, 101, 32, 106, 111, 105, 110, 32, 67, 108, 117, 98, 32, 71, 114, 101, 101, 110, 83, 111, 99, 107, 32, 116, 111, 32, 103, 101, 116, 32, 102, 117, 108, 108, 32, 97, 99, 99, 101, 115, 115, 32, 116, 111, 32, 116, 104, 101, 32, 98, 111, 110, 117, 115, 32, 112, 108, 117, 103, 105, 110, 115, 32, 116, 104, 97, 116, 32, 98, 111, 111, 115, 116, 32, 121, 111, 117, 114, 32, 97, 110, 105, 109, 97, 116, 105, 111, 110, 32, 115, 117, 112, 101, 114, 112, 111, 119, 101, 114, 115, 46, 32, 68, 105, 115, 97, 98, 108, 101, 32, 116, 104, 105, 115, 32, 119, 97, 114, 110, 105, 110, 103, 32, 119, 105, 116, 104, 32, 103, 115, 97, 112, 46, 99, 111, 110, 102, 105, 103, 40, 123, 116, 114, 105, 97, 108, 87, 97, 114, 110, 58, 32, 102, 97, 108, 115, 101, 125, 41, 59)), console.log(jt(37, 99, 71, 101, 116, 32, 117, 110, 114, 101, 115, 116, 114, 105, 99, 116, 101, 100, 32, 102, 105, 108, 101, 115, 32, 97, 116, 32, 104, 116, 116, 112, 115, 58, 47, 47, 103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109, 47, 99, 108, 117, 98), jt(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 49, 54, 112, 120, 59, 99, 111, 108, 111, 114, 58, 35, 52, 101, 57, 56, 49, 53)), window._gsapWarned = 1)))
                }, o = i.length;
            for (setTimeout(n, 50); --o > -1;) if (-1 !== t.indexOf(i[o])) return !0;
            s || setTimeout((function () {
                e && (console.log(jt(104, 116, 116, 112, 115, 58, 47, 47) + zt + jt(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) + "?plugin=MotionPathHelper&source=trial"))
            }), 3e3)
        }("undefined" != typeof window ? window.location.host : ""), /(^[#\.][a-z]|[a-y][a-z])/i),
        Wt = t => "string" == typeof t, Ft = (t, e) => {
            let s = Xt.createElementNS ? Xt.createElementNS((e || "http://www.w3.org/1999/xhtml").replace(/^https/, "http"), t) : Xt.createElement(t);
            return s.style ? s : Xt.createElement(t)
        }, Ut = (t, e, s) => Wt(t) && Bt.test(t) ? Xt.querySelector(t) : Array.isArray(t) ? Vt(Yt([{
            x: Nt.getProperty(e, "x"),
            y: Nt.getProperty(e, "y")
        }, ...t], s)) : Wt(t) || t && "path" === (t.tagName + "").toLowerCase() ? t : 0,
        Zt = {matrix: {a: 1, b: 0, c: 0, d: 1, e: 0, f: 0}}, $t = (t, e) => {
            let s = "Please gsap.registerPlugin(MotionPathPlugin)";
            Lt = window, Nt = Nt || t || Lt.gsap || console.warn(s), Xt = document, Ot = Xt.body, It = Xt.documentElement, qt = Nt && Nt.plugins.motionPath, qt ? (Gt = Ft("textarea"), Gt.style.display = "none", Ot.appendChild(Gt), Yt = qt.arrayToRawPath, Vt = qt.rawPathToString) : !0 === e && console.warn(s)
        };

    class Kt {
        constructor(t, e = {}) {
            qt || $t(e.gsap, 1);
            let s, i, n, o, r, a, h, l, c, d, g, p, u, _ = Ft("div"), f = this, m = {x: 0, y: 0};
            t instanceof Nt.core.Tween ? (l = t, s = l.targets()[0]) : (s = Nt.utils.toArray(t)[0], l = (t => {
                let e = Nt.getTweensOf(t), s = 0;
                for (; s < e.length; s++) {
                    if (e[s].vars.motionPath) return e[s];
                    e[s].timeline && e.push(...e[s].timeline.getChildren())
                }
            })(s)), i = Ut(e.path, s, e), this.offset = m, a = (t => {
                let e = t.getBoundingClientRect(),
                    s = It.clientTop - (Lt.pageYOffset || It.scrollTop || Ot.scrollTop || 0),
                    i = It.clientLeft - (Lt.pageXOffset || It.scrollLeft || Ot.scrollLeft || 0);
                return {left: e.left + i, top: e.top + s, right: e.right + i, bottom: e.bottom + s}
            })(s), o = parseFloat(Nt.getProperty(s, "x", "px")), r = parseFloat(Nt.getProperty(s, "y", "px")), n = s.getCTM && "svg" !== s.tagName.toLowerCase(), l && !i && (i = Ut(l.vars.motionPath.path || l.vars.motionPath, s, l.vars.motionPath)), _.setAttribute("class", "copy-motion-path"), _.style.cssText = "border-radius:8px; background-color:rgba(85, 85, 85, 0.7); color:#fff; cursor:pointer; padding:6px 12px; font-family:Signika Negative, Arial, sans-serif; position:fixed; left:50%; transform:translate(-50%, 0); font-size:19px; bottom:10px", _.innerText = "COPY MOTION PATH", _._gsHelper = f, (Nt.utils.toArray(e.container)[0] || Ot).appendChild(_), ((t, e, s) => {
                t.addEventListener("click", i => {
                    if (i.target._gsHelper) {
                        let n = e(i.target);
                        if (Gt.value = n, n && Gt.select) {
                            console.log(n), Gt.style.display = "block", Gt.select();
                            try {
                                Xt.execCommand("copy"), Gt.blur(), s && s(t)
                            } catch (t) {
