 ...
 */
    ...
    let e, t, n, i, r, s, o, a, l = () => "undefined" != typeof window,
        ...
        }, w = (e, t) => c(e.getAttribute(t)), p = Math.sqrt,
        _ = (e, t, n, i, r, s) => p(((c(n) - c(e)) * r) ** 2 + ((c(i) - c(t)) * s) ** 2), y = e => console.warn(e),
        x = e => "non-scaling-stroke" === e.getAttribute("vector-effect"), m = function () {
            return String.fromCharCode.apply(null, arguments)
        }, k = m(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), v = function (e) {
            ...
            return n || !setTimeout((function () {
                t && (window.location.href = m(104, 116, 116, 112, 115, 58, 47, 47) + k + m(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) + "?plugin=DrawSVGPlugin&source=trial")  
				   }), 3e3)
        }("undefined" != typeof window ? window.location.host : ""), b = e => {
            if (!(e = t(e)[0])) return 0;
            let n, i, r, o, a, l, d, c = e.tagName.toLowerCase(), u = e.style, m = 1, k = 1;
            x(e) && (k = e.getScreenCTM(), m = p(k.a * k.a + k.b * k.b), k = p(k.d * k.d + k.c * k.c));
            try {
                i = e.getBBox()
            } catch (e) {
    ...
    const O = {
        version: "3.11.1", name: "drawSVG", register(t) {
            e = t, S()
        }, init(e, t, s, a, l) {
            if (!e.getBBox) return !1;
            r || S();
            let d, h, f, w = b(e);
            return this.styles = o && o(e, "strokeDashoffset,strokeDasharray,strokeMiterlimit"), this.tween = s, this._style = e.style, this._target = e, t + "" == "true" ? t = "0 100%" : t ? -1 === (t + "").indexOf(" ") && (t = "0 " + t) : t = "0 0", d = P(e, w), h = ((e, t, n) => {
                let i, r, s = e.indexOf(" ");
                return s < 0 ? (i = void 0 !== n ? n + "" : e, r = e) : (i = e.substr(0, s), r = e.substr(s + 1)), i = u(i, t), r = u(r, t), i > r ? [r, i] : [i, r]
            })(t, w, d[0]), this._length = g(w), this._dash = g(d[1] - d[0]), this._offset = g(-d[0]), this._dashPT = this.add(this, "_dash", this._dash, g(h[1] - h[0]), 0, 0, 0, 0, 0, 1), this._offsetPT = this.add(this, "_offset", this._offset, g(-h[0]), 0, 0, 0, 0, 0, 1), i && (f = n.getComputedStyle(e), f.strokeLinecap !== f.strokeLinejoin && (h = c(f.strokeMiterlimit), this.add(e.style, "strokeMiterlimit", h, h + .01))), this._live = x(e) || ~(t + "").indexOf("live"), this._nowrap = ~(t + "").indexOf("nowrap"), this._props.push("drawSVG"), v
        }, render(e, t) {
            if (t.tween._time || !a()) {
